...
This works similarly to the `draw_arm` [endpoint for MABs](../mabs/run-experiment.md), but crucially require the context to be input in addition to the `experiment_id`.
