...
import { BadgeCheck, ChevronsUpDown, Blocks, LogOut } from "lucide-react";
...
export function NavUser({
  ...
  // Get initial of the user's name in capital letters
  const loadingUser = {
    firstName: "?",
    lastName: "?",
    username: "loading",
  ...
  const userToDisplay = user || loadingUser;
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8 rounded-lg">
                <AvatarImage src={userToDisplay.avatar} alt={fullName} />
